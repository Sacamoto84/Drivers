...
extern unsigned char PCD8544_Buffer[PCD8544_BUFFER_SIZE]; //504 �����
...
extern void PCD8544_Clear(uint8_t color);
extern void PCD8544_SetPixel(uint16_t x, uint16_t y, uint16_t pixel);
...
extern char PCD8544_GetPixel(uint16_t x, uint16_t y);
