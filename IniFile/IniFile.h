...
public:
	...
	IniFile(const char* filename, mode_t mode = FA_READ, bool caseSensitive = false);
	...
	static error_t readLine(FIL &file, char *buffer, size_t len, uint32_t &pos);
	...
	void printErrorMessage(bool eol = true);
...
private:
	...
	mutable boolean _file = false;
	mutable FIL _fatfsfile;
	bool _caseSensitive;
};
