...
DR_EXPLAIN.data_menu = {
    // menu
    DREX_NODE_NAMES: ["Начальная страница","STM32","Работа с текстом","SEGGER","USB","GyverButton","uTFT","Инициализация","USB"],
    DREX_NODE_LINKS: ["index.htm","stm32.htm","rabota_s_tekstom.htm","segger.htm","usb_1.htm","gyverbutton.htm","utft.htm","initsializatsiya.htm","usb_2.htm"],
    DREX_NODE_CHILD_START: [1,3,7,7,7,7,7,8,9],
    DREX_NODE_CHILD_END: [3,7,7,7,7,7,8,9,9],
    DREX_MENU_TYPE: 0,
