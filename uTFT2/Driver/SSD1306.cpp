...
void TFT::SSD1306_WRITECOMMAND(uint8_t data)
{
	if (LCD->hi2c)  //I2C
	{
		uint8_t dt[2];
...
void TFT::SSD1306_WRITEDATA(uint8_t data)
{
	if (LCD->hi2c)  //I2C
	{
		uint8_t dt[2];
...
//490uS-72MHz
void TFT::SSD1306_UpdateScreen(void) {
    uint8_t * p;
...
void TFT::SSD1306_Contrast(uint8_t c)
{
