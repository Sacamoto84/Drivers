#ifndef __MYILI9341_H
#define __MYILI9341_H
...
#define  RESET_ACTIVE   HAL_GPIO_WritePin(GPIOD, GPIO_PIN_3, GPIO_PIN_RESET);
#define  RESET_IDLE     HAL_GPIO_WritePin(GPIOD, GPIO_PIN_3, GPIO_PIN_SET);
...
#define BACKGROUND convert24to16(0xD5C4AB) 
...
void TFT9341_ini(void);	//Инициализация диплея		
