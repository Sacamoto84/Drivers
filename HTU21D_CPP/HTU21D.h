...
#define HTU21D_ADDRESS               0x80      //chip i2c address
...
class HTU21D
{
  public:
	...
	HTU21D(HTU21D_RESOLUTION = HTU21D_RES_RH12_TEMP14); //Конструктор

	 bool     begin(I2C_HandleTypeDef * _hi2c); //Выбор I2C порта
