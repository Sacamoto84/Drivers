...
void BLE::init(UART_HandleTypeDef * rx, UART_HandleTypeDef * tx)
{
	_huart_rx = rx;
	_huart_tx = tx;
}
...
void BLE::USART_RX_IRQHandler(void)
{
	...
	if ((_huart_rx->Instance->SR) & USART_SR_ORE)
	{
		
	}
	
  //При приеме помещаем в буффер данные
  if ((_huart_rx->Instance->SR & USART_SR_RXNE) && ((_huart_rx->Instance->SR & USART_SR_ORE) == 0))
  {
		USART_data = _huart_rx->Instance->DR;
...
void BLE::BLE_UART_Decode_Level_1(int PosS, int PosCRC)
{
	int i;
  ...
  //Разбераем уже сам пакет
    ...
    SEGGER_RTT_printf(0, "%s%sL1> Code > %d%s\n", RTT_CTRL_TEXT_BRIGHT_WHITE, RTT_CTRL_BG_BRIGHT_BLUE,code_index,RTT_CTRL_RESET);

  switch (code_index)
  {
		//case 0:  BLE_Code_00(PosS + 4, PosCRC - PosS - 4);	break;
		//case 1:  BLE_Code_01(PosS + 4, PosCRC - PosS - 4);	break;
		//case 2:  BLE_Code_02(PosS + 4, PosCRC - PosS - 4);	break;
		//case 3:  BLE_Code_03(PosS + 4, PosCRC - PosS - 4);	break;
		//case 4:  BLE_Code_04(PosS + 4, PosCRC - PosS - 4);	break;
		//case 5:  BLE_Code_05(PosS + 4, PosCRC - PosS - 4);	break;
		//case 6:  BLE_Code_06(PosS + 4, PosCRC - PosS - 4);	break;
		//case 7:  BLE_Code_07(PosS + 4, PosCRC - PosS - 4);	break;
		//case 8:  BLE_Code_08(PosS + 4, PosCRC - PosS - 4);	break;
		//case 9:  BLE_Code_09(PosS + 4, PosCRC - PosS - 4);	break;
		//case 10: BLE_Code_10(PosS + 4, PosCRC - PosS - 4);	break;
		//case 11: BLE_Code_11(PosS + 4, PosCRC - PosS - 4);	break;
		//case 12: BLE_Code_12(PosS + 4, PosCRC - PosS - 4);	break;
		//case 13: BLE_Code_13(PosS + 4, PosCRC - PosS - 4);	break;
		//case 14: BLE_Code_14(PosS + 4, PosCRC - PosS - 4);	break;
		//case 15: BLE_Code_15(PosS + 4, PosCRC - PosS - 4);	break;
		//case 16: BLE_Code_16(PosS + 4, PosCRC - PosS - 4);	break;
		//case 17: BLE_Code_17(PosS + 4, PosCRC - PosS - 4);	break;
		//case 18: BLE_Code_18(PosS + 4, PosCRC - PosS - 4);	break;
		//case 19: BLE_Code_19(PosS + 4, PosCRC - PosS - 4);	break;
		//case 20: BLE_Code_20(PosS + 4, PosCRC - PosS - 4);	break;
		//case 21: BLE_Code_21(PosS + 4, PosCRC - PosS - 4);	break;
		
		//case 50: BLE_Code_50(PosS + 4, PosCRC - PosS - 4);	break;
		case 98: BLE_Code_98(PosS + 4, PosCRC - PosS - 4);	break; //CLI

  	    //case 99: BLE_Code_99(PosS + 4, PosCRC - PosS - 4);	break;

    default: SEGGER_RTT_printf(0, "L1 > Error > Unsupported code_index : %d\n", code_index);
  		break;
  }
